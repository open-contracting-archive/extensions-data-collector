...
def main():
    ...
    parser.add_argument('output-dir', help='the directory in which to write the output')
    ...
    runner = Runner(args.output_dir, limit=args.limit, tx_api_key=args.tx_api_key)
    runner.run()
